                    ...
                    <div className="bg-[#D3E9FD] p-8 rounded-3xl">
                        ...
                        <form
                            ...
                            onSubmit={(e) => {
                                ...
                                const subject = `New Message from ${name} - Job Inquiry: ${job.title}`;
                                const body = `Name: ${name}\nEmail: ${email}\nPhone: ${phone}\n\nMessage:\n${message}`;

                                window.location.href = `mailto:shivamsingh21062005@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
                            }}
                        >
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                                <input name="name" type="text" placeholder="Full name" required className="w-full pl-12 pr-4 py-3 rounded-xl border-none focus:ring-2 focus:ring-[#05033e]/20 bg-white" />
                            </div>
                            <div className="relative">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                                <input name="email" type="email" placeholder="Email Address" required className="w-full pl-12 pr-4 py-3 rounded-xl border-none focus:ring-2 focus:ring-[#05033e]/20 bg-white" />
                            </div>
                            <div className="relative">
                                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                                <input name="phone" type="tel" placeholder="Phone Number" className="w-full pl-12 pr-4 py-3 rounded-xl border-none focus:ring-2 focus:ring-[#05033e]/20 bg-white" />
                            </div>
                            <div className="relative">
                                <MessageSquare className="absolute left-4 top-4 text-gray-400" size={18} />
                                <textarea name="message" placeholder="Your Message" rows={4} required className="w-full pl-12 pr-4 py-3 rounded-xl border-none focus:ring-2 focus:ring-[#05033e]/20 resize-none bg-white"></textarea>
                            </div>
                            <button type="submit" className="w-full bg-[#05033e] text-white font-bold py-3 rounded-xl hover:bg-[#020120] transition-colors shadow-lg">
                                Send Message
                            </button>
                        </form>
                    </div>

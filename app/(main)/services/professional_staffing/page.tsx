        ...
        <main className="bg-white overflow-x-hidden">
            ...
            >
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <img src="/images/professional-staffing-hero.png" alt="Professional Staffing Hero" className="w-full h-full object-cover" />
                </div>
                ...
                <div className={`relative z-10 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                    <h1 className="text-white text-4xl md:text-6xl font-bold mb-4">
                        Professional <span style={{ color: "#96c2ecff", textShadow: "0 0 20px rgba(5,3,62,0.3)" }}>Staffing</span>
                    </h1>
            ...
            <section className="py-24">
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        {/* Header Image: Generated by AI (saved as /public/images/professional-staffing-meeting.png) */}
                        <div className="absolute inset-0 bg-[#0a0a0a]/10 group-hover:bg-transparent transition-colors z-10" />
                        <img
                            src="/images/professional-staffing-meeting.png"
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div
                                    ...
                                    style={{ backgroundColor: "#05033e", color: "#fff" }}
                                >
                                    <Users className="w-10 h-10 group-hover:text-white transition-colors" />
                                </div>
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div
                                    ...
                                    style={{ backgroundColor: "#05033e", color: "#fff" }}
                                >
                                    <Settings className="w-10 h-10 group-hover:text-white transition-colors" />
                                </div>
                                <h4 className="text-xl font-bold text-gray-900 mb-3">
                                    Managed Solutions
                                </h4>
